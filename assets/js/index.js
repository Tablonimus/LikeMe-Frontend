// const URL_BASE = "http://localhost:3000"//LOCALHOST
const URL_BASE = "https://likeme-backend.onrender.com";
...
$(document).ready(function () {
  $("form:first").submit(async (e) => {
    ...
    const { data } = await axios.post(`${URL_BASE}/posts`, {
      titulo,
      img,
      descripcion,
    });
...
function like(id) {
  axios.put(`${URL_BASE}/posts/${id}`).then(() => {
    getPosts();
  });
}
